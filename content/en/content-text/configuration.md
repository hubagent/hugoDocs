...
imaging
: See [Image Processing Config](/form-elements/image-processing/#image-processing-config).

languages
: See [Configure Languages](/form-elements/multilingual/#configure-languages).
...
disableLanguages
: See [Disable a Language](/form-elements/multilingual/#disable-a-language)
...
menu
: See [Add Non-content Entries to a Menu](/form-elements/menus/#add-non-content-entries-to-a-menu).
...
permalinks
: See [Content Management](/form-elements/urls/#permalinks).
...
related
: See [Related Content](/form-elements/related/#configure-related-content).
...
summaryLength (70)
: The length of text to show in a [`.Summary`](/form-elements/summaries/#hugo-defined-automatic-summary-splitting).

taxonomies
: See [Configure Taxonomies](/form-elements/taxonomies#configure-taxonomies).
...
[static-files]: /form-elements/static-files/
