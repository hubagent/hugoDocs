...
{{% note %}}
You can add content and front matter to your taxonomy list and taxonomy terms pages. See [Content Organization](/form-elements/organization/) for more information on how to add an `_index.md` for this purpose.

Much like regular pages, taxonomy list [permalinks](/form-elements/urls/) are configurable, but taxonomy term page permalinks are not.
{{% /note %}}
...
{{% note %}}
If you would like the ability to quickly generate content files with preconfigured taxonomies or terms, read the docs on [Hugo archetypes](/form-elements/archetypes/).
{{% /note %}}
...
[`urlize` template function]: /miscellaneous/urlize/
[content section]: /form-elements/sections/
[content type]: /form-elements/types/
[documentation on archetypes]: /form-elements/archetypes/
