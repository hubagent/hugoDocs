...
If you make use of the [multilingual feature](/form-elements/multilingual/), you can define language-independent menus.
{{% /note %}}
...
Hugo allows you to add content to a menu via the content's [front matter](/form-elements/front-matter/).
