...
Read a more extensive description of `ref` and `relref` in the [cross references](/form-elements/cross-references/) documentation.
{{% /note %}}
...
[contentmanagementsection]: /form-elements/formats/
