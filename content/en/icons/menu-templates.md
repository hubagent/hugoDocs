...
Use the [`absLangUrl`](/miscellaneous/abslangurl) or [`relLangUrl`](/miscellaneous/rellangurl) functions if your theme makes use of the [multilingual feature](/form-elements/multilingual/). In contrast to `absURL` and `relURL`, these two functions add the correct language prefix to the url.
{{% /note %}}
