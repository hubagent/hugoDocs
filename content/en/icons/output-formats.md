...
sections_weight: 18
draft: false
aliases: [/templates/outputs/,/extras/output-formats/,/form-elements/custom-outputs/]
toc: true
---
...
From content files, you can use the [`ref` or `relref` shortcodes](/form-elements/shortcodes/#ref-and-relref):
