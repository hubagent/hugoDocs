...
Hugo's Open Graph template is configured using a mix of configuration variables and [front-matter](/form-elements/front-matter/) on individual pages.
...
Hugo's Twitter Card template is configured using a mix of configuration variables and [front-matter](/form-elements/front-matter/) on individual pages.
...
If `images` aren't specified in the page front-matter, then hugo searches for [image page resources](/form-elements/image-processing/) with `feature`, `cover`, or `thumbnail` in their name.
