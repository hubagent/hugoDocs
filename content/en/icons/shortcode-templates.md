...
{{% note %}}
Hugo also ships with built-in shortcodes for common use cases. (See [Content Management: Shortcodes](/form-elements/shortcodes/).)
{{% /note %}}
...
Use the [errorf](/miscellaneous/errorf) template func and [.Position](/variables/shortcodes/) variable to get useful error messages in shortcodes:
...
[basic content files]: /form-elements/formats/ "See how Hugo leverages markdown--and other supported formats--to create content for your website."
[built-in shortcode]: /form-elements/shortcodes/
...
[Content Management: Shortcodes]: /form-elements/shortcodes/#using-hugo-s-built-in-shortcodes "Check this section if you are not familiar with the definition of what a shortcode is or if you are unfamiliar with how to use Hugo's built-in shortcodes in your content files."
...
[figure]: /form-elements/shortcodes/#figure
[hugosc]: /form-elements/shortcodes/#using-hugo-s-built-in-shortcodes
...
[youtubeshortcode]: /form-elements/shortcodes/#youtube "See how to use Hugo's built-in YouTube shortcode."
