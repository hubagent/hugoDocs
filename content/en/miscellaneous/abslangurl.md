...
Both `absLangURL` and [`relLangURL`](/miscellaneous/rellangurl/) are similar to their [`absURL`](/miscellaneous/absurl/) and [`relURL`](/miscellaneous/relurl) relatives but will add the correct language prefix when the site is configured with more than one language.
