...
{{% warning %}}
As of v0.19 of Hugo, the `dateFormat` function is *not* supported as part of Hugo's [multilingual feature](/form-elements/multilingual/).
{{% /warning %}}

See the [`Format` function](/miscellaneous/format/) for a more complete list of date formatting options in your templates.
