...
The function accept either a `Resource` created in [Hugo Pipes](/hugo-pipes/) or via [Page Bundles](/form-elements/page-bundles/), or simply a string. The two examples below will produce the same map:
